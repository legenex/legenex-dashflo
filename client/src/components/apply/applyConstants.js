...
// Resolved at use time so the controlled apex-to-app hostname transition can
// be made through public runtime configuration after app DNS and TLS are live.
export const publicApplicationUrl = () => `${resolveApplicationBaseUrl()}/apply`;
