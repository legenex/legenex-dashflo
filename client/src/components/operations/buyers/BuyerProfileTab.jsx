...
// Editable form over a single Buyer record. Buyer ID (buyer_code) and status
// are shown read only. Save writes only the fields on this form.
//
// leadbyte_bid is deliberately not shown or edited here: it is a legacy
// compatibility alias that defaults to buyer_code and is kept only for
// reconciling older migrated data, not a field an operator manages.
export default function BuyerProfileTab({ buyer, verticals }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="pt-1">
        <SectionLabel>Billing &amp; Delivery Policy</SectionLabel>
        <div className="grid grid-cols-2 gap-4">
