...
// Sticky action bar shown when one or more suppliers are selected. Offers a
// bulk delete guarded by a simple Yes/No confirmation (no name typing).
export default function SupplierBulkDeleteBar({ count, onClear, onConfirmDelete, deleting }) {
  ...
  return (
    <>
      ...
      <AlertDialog open={open} onOpenChange={setOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete {count} {count === 1 ? 'supplier' : 'suppliers'}?</AlertDialogTitle>
            <AlertDialogDescription>
              This permanently removes the selected {count === 1 ? 'supplier' : 'suppliers'}. This cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
