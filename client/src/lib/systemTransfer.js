...
// Owner-only encrypted Base44 migration bundle. Unlike the ordinary system
// export, this catalog includes durable credentials so DashFlo can preserve
// live integration identities. Authentication/session state remains excluded.
