# Wave 00: Foundations and independent work

**Target date:** Fri 5 Sep
**Units:** W0-AUDIT, W1-FLAGS, W5-EMPTY-STATES, W6-FIXTURES, W13-OFFSITE
...
Nothing here depends on anything. W1-FLAGS is the highest value: it must land before the status migration or historical revenue is unprotected. W0-AUDIT unblocks two later units. W13-OFFSITE is blocked on an owner decision and should be raised in the first digest, not worked around.

## Write ownership

W1-FLAGS owns Lead.json and db/schema.js this wave. Nothing else may touch them.
